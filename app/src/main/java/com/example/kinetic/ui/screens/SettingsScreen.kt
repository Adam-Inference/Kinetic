    ...
    Surface(
        ...
        LazyColumn(
            ...
            item {
                ...
                Divider(color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.16f))
            }
...
private fun ThemeOptions(
    ...
    val options = listOf(
        SettingsAccent.Cosmic,
        SettingsAccent.Pulse,
        SettingsAccent.Ember
    )
...
@Composable
fun SettingsAestheticDarkModePreview(
    state: SettingsState = SettingsState(
        isDarkModeEnabled = true,
        selectedAccent = SettingsAccent.Cosmic,
        showWorkoutTutorials = true,
